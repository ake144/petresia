    ...
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]" id="home">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="w-5 h-5 bg-gradient-to-r from-indigo-300 to-rose-300 rounded-full"></div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
              Guided by the Esperanza Charter: A bedrock for principled, open, and equitable intelligence. Forged in Africa, empowering the globe.
            </p>
          </motion.div>
          ...
          >
            <Link href='/Petresia_Manifesto1.pdf'  target="_blank" rel="noopener noreferrer">

              <RippleButton>Read the Manifesto</RippleButton>
           </Link>

         <Link href='/Petresia_DayOne_Declaration.pdf'  target="_blank" rel="noopener noreferrer">
