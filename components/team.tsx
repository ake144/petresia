...
export function Teams() {
  return (
    <div
      className="relative py-32 min-h-screen overflow-hidden bg-[#030303]"
      id="team"
    >
      ...
      >
        ...
        >
          ...
          compute for ethical AI workloads — prioritized by the Esperanza
          Charter and stewarded with transparency, fairness, and global access.
        </motion.p>
      </motion.div>
...
const Card = ({
  ...
  return (
    <div
      ...
      className="
        group/canvas-card relative flex items-center justify-center
        max-w-sm w-full mx-auto h-[30rem] p-4
        rounded-xl
    ...
    >
      {/* Corner icons */}
      <Icon className="absolute h-6 w-6 -top-3 -left-3 text-gray-400 dark:text-gray-200" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 text-gray-400 dark:text-gray-200" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 text-gray-400 dark:text-gray-200" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 text-gray-400 dark:text-gray-200" />
      ...
      <div className="relative z-20">
        ...
        <h2
          className="text-xl font-bold mt-4 text-white opacity-0 
